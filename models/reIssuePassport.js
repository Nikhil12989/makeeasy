...
const reIssuePassport = new mongoose.Schema({
    typeOfApplication: { type: String, required: true },
    typeOfPassport: { type: String, required: true },
    reasonOfReIssue: { type: String, required: true },
    oldPassportNumber: { type: String, required: true },
...
export default mongoose.model('reIssuePassport ', reIssuePassport)